 ...
 */
class SocialpromoterViewDefault extends JViewLegacy
{
	// Overwriting JView display method
	function display($tpl = null){
            // Assign data to the view
            $model = $this->getModel();
            $this->items = $model->getNextItem();
            //$this->msg = 'Mitt meddelande';
            // Display the view
            parent::display($tpl);
	}
        
        function cron($tpl = null){
            $this->items = 'Mitt meddelande';
            parent::display($tpl);
        }
}
